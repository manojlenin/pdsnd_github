...
""" By Manoj:- Dictionary to store data for csv file for respecitve city. Key hold the city name and value with filename. The files are saved under Datafolder"""
